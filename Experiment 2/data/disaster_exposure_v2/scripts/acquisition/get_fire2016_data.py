...
S=Path('/Users/ray/Research/AUSSEF/outputs/disaster_exposure_v2/sources');x=json.loads((S/'fire-extent-and-severity-mapping-fesm-2016-2017.json').read_text())['result'];m=[]
