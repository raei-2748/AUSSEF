...
cs=pd.read_csv(R/'Experiment 2/data/fiscal_panel_v2/council_selection.csv');selected=cs[cs.included].copy();keys=set(selected.council_key);assert len(keys)==103
...
assert len(fire)==515
base=pd.read_csv(R/'Experiment 2/data/fiscal_panel_v2/NSW_Fiscal_Panel_V2_candidate.csv')[['council_key','council_name','year_start','financial_year']]
