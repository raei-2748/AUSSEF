...
ROOT=Path('/Users/ray/Research/AUSSEF');OUT=Path(sys.argv[1]);c=sqlite3.connect(OUT/'experiment4.sqlite');c.execute('PRAGMA foreign_keys=ON');p=ROOT/'Experiment 4/data/raw_extension/griffith_aug2020.pdf'
with c:
